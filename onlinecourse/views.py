...
def submit(request, course_id):
        ...
        #return redirect('onlinecourse:show_exam_result', args=(course.id,))
        return HttpResponseRedirect(reverse(viewname='onlinecourse:show_exam_result', args=(submitted_answers,)))  ## 11 AUG added
...
def show_exam_result(request, course_id,submitted_answers):
    #def show_exam_result(request, course_id, submission_id):  完全9黎
    
    course = get_object_or_404(Course,pk=course_id)
    #submission = get_object_or_404(Submission, pk=choice_id)
    #print(submission)
    context = {}
